...
def create_tabs(root, style):
    ...
    labelEntrySTab2 = ttk.Label(Tab2EntryFrame, text="Length 1 (m)").grid(row=0, column=0)
    entrySTab2 = ttk.Entry(Tab2EntryFrame).grid(row=0, column=1)
    labelEntryTTab2 = ttk.Label(Tab2EntryFrame, text="Length 2 (m)").grid(row=0, column=2)
